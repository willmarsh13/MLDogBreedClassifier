...
vgg_bottleneck = VGG19(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
...
checkpointer = ModelCheckpoint(filepath='saved_model_VGG19.h5', verbose=1, save_best_only=True)
...
model.load_weights('saved_model_VGG19.h5')
